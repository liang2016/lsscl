...
<script type="text/javascript">
  ...
  function setDB(handler){
                $set("id",handler.setting.id)
                 ...
                 $set("sendContory",handler.setting.sendContory);
    ...
    function saveEmialSetting(){
            ...
            var checkedSend=$("sendControy");
            if(checkedSMS.checked)
              userSMS=true;
            else
              userSMS=false;
           //default factoryId=43
           if(checkedSend.checked)
        	  sendControy=true;
           else
        	  sendControy=false;
        	   

           FactorySettingDwr.save($get("id"),$get("scopeId"),emailList,$get("sendEscalation"), $get("escalationDelayType"), $get("escalationDelay"),escalList,$get("sendEscalation2"),$get("escalationDelayType2"), $get("escalationDelay2"),escalList2,$get("sendInactive"),$get("inactiveOverride"),inactiveList,userSMS,sendControy,info);
    }
